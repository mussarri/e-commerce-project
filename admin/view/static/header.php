...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/mssiioo9a2r79gm8vdx923i0gvw0b18y5p8hf4qqtigy4162/tinymce/6/tinymce.min.js"
    ...
    <link href="<?= admin_public_url() ?>css/sb-admin-2.min.css?12" rel="stylesheet">
    ...
    <script src="<?= admin_public_url() ?>vendor/chart.js/Chart.min.js"></script>

    <script src="<?= admin_public_url() ?>js/demo/chart-area-demo.js"></script>
    <script src="<?= admin_public_url() ?>js/demo/chart-pie-demo.js"></script>
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        foreach ($admin_menu as $menu):?>
            <li class="nav-item <?= route(1) == $menu['url'] ? ' active' : '' ?>">
                <a class="nav-link" href="<?= admin_url($menu['url']) ?>">
                    ...
                    <li class="nav-item dropdown no-arrow mx-1">
                        <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <!-- Counter - Messages -->
                            <span class="badge badge-<?= $messages ? 'danger' : 'light' ?> badge-counter"><?= $count
                                ?></span>
                        </a>
                        <!-- Dropdown - Messages -->
                        <?php if ($messages): ?>
