            ...
            <div class="row">
                        ...
                        <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                            ...
                            foreach ($allCategories as $category): ?>
                                <div class="panel panel-default">
                                    <div
                                        class="panel-heading<?= $category['id'] == $mainCategoryId ? ' active' : '' ?>">
                                    ...
                                    <div
                                        class="panel-collapse collapse<?= $category['id'] == $mainCategoryId ? ' show' :
                                            '' ?>">
                                        <div class="panel-body">
                                            <ul>
                                                ...
                                                foreach ($subcategories as $subcategory):
                                                    ?>
                                                    <li class="<?= $subcategory['id'] == $subCategory ? ' active' : '' ?>">
                ...
                <div class="col-sm-9 padding-right">
                    <div class="features_items"><!--features_items-->
                        ...
                        <?php
                        $query = $db->prepare('SELECT * FROM ecommerce.product WHERE category_id=:category_id');
                        $query->execute([
